...
const short=await instance.playground.run({code:fs.readFileSync('tools/verify-short-fields.php','utf8')});console.log(short.text);if(short.errors||short.exitCode)throw Error(short.errors||short.text);
