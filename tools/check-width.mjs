...
await page.setViewportSize({width:1920,height:1080});await page.goto('http://127.0.0.1:9477/',{waitUntil:'networkidle'});await page.screenshot({path:'verification/home-full-width.png'});
fs.writeFileSync('verification/full-width-checks.json',JSON.stringify(results,null,2));console.log('Passed: all eight pages fill 1920px; home also checked at 2560, 1280, 1024, and 390px.');await browser.close();
