...
try {
  const result = await instance.playground.run({
    code: `<?php require '/wordpress/wp-load.php';ps_import_design_content();wp_set_current_user(1);
...
echo 'Seven CSS/editor colors, Astra palette, legacy emblem refresh, alt preservation and repeat safety passed.';`,
  });
