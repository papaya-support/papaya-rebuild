...
<?php get_template_part('template-parts/components/content-items', null, ['items' => $args['before']]); ?>
...
<?php get_template_part('template-parts/components/content-items', null, ['items' => $args['after']]); ?>
</div>
</section>
