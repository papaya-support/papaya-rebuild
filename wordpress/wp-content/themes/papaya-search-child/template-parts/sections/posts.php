...
$listing=$args['listing'];$posts=$listing['query']; ?>
...
<?php if (!$posts->post_count) : ?><p class="blog-empty"><?php esc_html_e('No posts found. Please choose another category or check back soon.', 'papaya-search-child'); ?></p><?php endif; ?>
</div>
</section>
...
echo wp_kses_post(paginate_links(['base'=>add_query_arg('blog_page','%#%',$base),'format'=>'','current'=>$listing['page'],'total'=>$posts->max_num_pages,'prev_text'=>'Previous','next_text'=>'Next','type'=>'list']));
?>
</nav>
<?php endif; ?>
