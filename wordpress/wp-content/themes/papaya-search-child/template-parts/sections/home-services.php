...
<?php /* ACF: SEO Service — Button Label */ ps_button('home_c04f66011766', ps_route('services').'#search-engine-optimization', 'button-small'); ?>
</div>
<div class="service-card">
...
<?php /* ACF: PPC Service — Button Label */ ps_button('home_fadcbf34d7f6', ps_route('search-engine-marketing'), 'button-small'); ?>
</div>
<div class="service-card">
...
<?php /* ACF: Analytics Service — Button Label */ ps_button('home_01079a482a16', ps_route('services').'#website-analytics', 'button-small'); ?>
</div>
<div class="service-card">
...
<?php /* ACF: AI SEO Service — Button Label */ ps_button('home_4dbc82586a2a', ps_destinations()['AI SEO'], 'button-small'); ?>
</div>
</div>
</div>
</section>
