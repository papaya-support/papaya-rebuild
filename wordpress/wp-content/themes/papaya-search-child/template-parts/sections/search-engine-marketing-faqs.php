...
<section class="section-search-engine-marketing-faqs section">
    <div class="container">
        <?php /* ACF: FAQs — Heading */
        ps_text('search_engine_marketing_de2d5ec0ff46', 'h2', 'section-title accent'); ?>
    </div>
    <div class="container split ">
        <div class="split-media">
            <?php /* ACF: FAQs — Image */
            ps_image('search_engine_marketing_image_ba13013ff2', '', false); ?>
        </div>
        <div class="split-copy">
            <details class="faq-item">
                ...
                <div class="faq-answer">
                    <?php ps_faq_answer('search_engine_marketing_e4c9a55704b0'); ?>
                </div>
            </details>
            <details class="faq-item">
                ...
                <div class="faq-answer">
                    <?php ps_faq_answer('search_engine_marketing_1a8f0aa708c3'); ?>
                </div>
            </details>
            <details class="faq-item">
                ...
                <div class="faq-answer">
                    <?php ps_faq_answer('search_engine_marketing_bb38e3397bbb'); ?>
                </div>
            </details>
            <details class="faq-item">
                ...
                <div class="faq-answer">
                    <?php ps_faq_answer('search_engine_marketing_12d045c16ab7'); ?>
                </div>
            </details>
            <details class="faq-item">
                ...
                <div class="faq-answer">
                    <?php ps_faq_answer('search_engine_marketing_49292f5e4eed'); ?>
                </div>
            </details>
            <details class="faq-item">
                ...
                <div class="faq-answer">
                    <?php ps_faq_answer('search_engine_marketing_6e5798b9f4ea'); ?>
                </div>
            </details>
