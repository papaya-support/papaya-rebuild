...
require_once __DIR__ . '/inc/case-studies.php';
...
add_action(
    ...
    function () {
        ...
        wp_enqueue_style(
            ...
            [],
            filemtime(__DIR__ . '/assets/site.css'),
        );
        wp_enqueue_script(
            'papaya-design',
            get_stylesheet_directory_uri() . '/assets/site.js',
            [],
            filemtime(__DIR__ . '/assets/site.js'),
            true,
        );
    },
    100,
...
add_filter('astra_get_option_scroll-to-top-enable', function ($enabled) {
    return !is_admin() &&
        is_page_template() &&
        str_starts_with(get_page_template_slug(), 'page-templates/')
        ? false
        : $enabled;
});
